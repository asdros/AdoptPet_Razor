...
namespace AdoptPet.Data.Migrations
{
    ...
    [Migration("20220211214615_updateModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdoptPet.Models.Ad", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AdoptPet.Models.Breed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdoptPet.Models.District", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdoptPet.Models.Ad", b =>
                {
                    b.HasOne("AdoptPet.Models.Breed", "Breed")
                        .WithMany()
                        .HasForeignKey("BreedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AdoptPet.Models.Place", "Place")
                        .WithMany()
            ...
            modelBuilder.Entity("AdoptPet.Models.Breed", b =>
                {
                    b.HasOne("AdoptPet.Models.Animal", "Animal")
                        .WithMany("Breeds")
            ...
            modelBuilder.Entity("AdoptPet.Models.District", b =>
                {
                    b.HasOne("AdoptPet.Models.Province", "Province")
                        .WithMany()
            ...
            modelBuilder.Entity("AdoptPet.Models.Image", b =>
                {
                    b.HasOne("AdoptPet.Models.Ad", "Ad")
                        .WithMany("Images")
                        .HasForeignKey("AdId")
            ...
            modelBuilder.Entity("AdoptPet.Models.Place", b =>
                {
                    b.HasOne("AdoptPet.Models.District", "District")
                        .WithMany()
